...
Feature: login function test
  ...
  Scenario: 输入有效的用户名和密码成功登录
    When 导航到登录页面
    Then 用户名输入'testuser1',密码输入'123456',点击登录按钮，登录成功，跳转首页，页面有'testuser1'个人信息
  ...
  Scenario Outline: 忘记密码功能
    ...
    Examples: 
      | email            | message   |
      | 914650@qq.com    | 没有这个电子邮箱。 |
      |                  | 邮箱不合法     |
      | 123.com          | 邮箱不合法     |
      | 914650562@qq.com | 没有这个电子邮箱。 |
      # |914650562@qq.com|我们已给您填写的电子邮箱发送了一封邮件，请在24小时内点击里面的链接来重置密码。|